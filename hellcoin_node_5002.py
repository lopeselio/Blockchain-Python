...
def mine_block():
    ...
    blockchain.add_transaction(sender = node_address, receiver = 'Crystal', amount = 1)
...
def replace_chain():
    ...
    if is_chain_replaced:
        response = {'message': 'The node had different chains, so the node was replaced by the longest one.',
